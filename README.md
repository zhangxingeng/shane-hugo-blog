...
This is a quick start template for [Hugo theme Stack](https://github.com/zhangxingeng/shane-hugo-theme). It uses [Hugo modules](https://gohugo.io/hugo-modules/) feature to load the theme.
...
```bash
hugo mod get -u github.com/zhangxingeng/shane-hugo-theme
hugo mod tidy
```
